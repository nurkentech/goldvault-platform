...
export default function LanguageSwitcher() {
  ...
  // The homepage PremiumNav already provides its own language control. Keeping
  // this second fixed control there placed it above the mobile menu button.
  if (location === "/" || location.startsWith("/dashboard") || location.startsWith("/admin")) return null;
  return <label className="fixed right-4 top-20 z-40 flex items-center gap-2 rounded-xl border border-white/10 bg-background/90 px-3 py-2 shadow-xl backdrop-blur">
