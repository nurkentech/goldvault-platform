...
import { startInvestmentMaturityHeartbeat } from "../investmentMaturity";
import { apiKeyRouter } from "../apiKeyRoutes";
import { startAdvancedFinancialHeartbeat } from "../advancedModules";
...
async function startServer() {
  ...
  server.listen(port, () => {
    ...
    startInvestmentMaturityHeartbeat();
    startAdvancedFinancialHeartbeat();
  });
}
